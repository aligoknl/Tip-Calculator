...
![Preview of Tip-Calculator!](GIF/tip_calculator.GIF)
...
## 5. Must Haves
-   A user should be able to enter amount and number of people.
-   A user should be able to click or enter a percentage to calculate the tip amount.
-   A user should see the result of tip amount and the payment that will be paid per person.

## 6. Nice-to Have

-   A user can reset the previous result with a button.
